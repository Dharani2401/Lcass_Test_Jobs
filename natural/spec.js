...
it('CallChain_testcase1' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CallChain');
...
browser.takeScreenshot().then(function (png) {var dir="natural";
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[2]/div/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[5]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-callchainapp/div[3]/div/div[5]/button is not present in current page. :Assertion Failed`);
//browser.quit();
}
});


browser.wait(until.presenceOf(element.all(by.xpath(`//a[@href="/natural/dashboard"]`)).get(1)), delay, 'Element taking too long to appear in the DOM');

browser.wait(until.elementToBeClickable(element.all(by.xpath(`//a[@href="/natural/dashboard"]`)).get(1)), delay);
element.all(by.xpath(`//a[@href="/natural/dashboard"]`)).get(1).getText().then(function(text){
var description =''; 
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(`//a[@href="/natural/dashboard"][1]`, text);
    }
else
    {
    Get_Text.set(`//a[@href="/natural/dashboard"][1]`, text[0]);
    }  
});
element.all(by.xpath(`//a[@href="/natural/dashboard"]`)).get(1).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/dashboard"][1]`, text);
    }
else
    {
    Get_Attribute.set(`//a[@href="/natural/dashboard"][1]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page6.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element.all(by.xpath(`//a[@href="/natural/dashboard"]`)).get(1).click();
...
it('XRefTotalEntriesRecord_testcase2' , function() {browser.ignoreSynchronization =true;
...
it('XRefReportClearSearch_testcase3' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : XRefReportClearSearch');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
console.log('test_step_inputNatural-Program');});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page23.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //input[@id="searchFilter"]`)).sendKeys(`Natural-Program`);
...
it('X-RefReport_testcase4' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : X-RefReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-x-ref-application/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
it('SpiderAutoFill_testcase5' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : SpiderAutoFill');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/spiderchartAppNat"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/spiderchartAppNat"]`))), delay);
element(by.xpath(` //a[@href="/natural/spiderchartAppNat"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/spiderchartAppNat"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/spiderchartAppNat"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/spiderchartAppNat"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/spiderchartAppNat"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/spiderchartAppNat"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page37.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/spiderchartAppNat"]`)).click();

browser.sleep(5000);var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-spiderfilterapp/div[2]/div/div[2]/select`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-spiderfilterapp/div[2]/div/div[2]/select contain All. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-spiderfilterapp/div[2]/div/div[2]/select But has All. :Assertion Failed`);
//browser.quit();
}
});
});
it('ScreenDefinition_testcase6' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ScreenDefinition');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(2000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[4]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-nat/div[4]/div[3]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[4]/div[3]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[1]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[1]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[2]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[2]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/a/img is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/a/img is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('ScreenDefinitionTotalEntriesRecord_testcase7' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ScreenDefinitionTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[6]/span`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[6]/span`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[6]/span`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[6]/span`)  }
...
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[1]/app-page-header/div/div/ol/li[2]`)).getText().then(function (text) {
var assert1='';
if( typeof text ==='object')
    {
    assert1=text[0];
...
console.log('Assertion Passed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[1]/app-page-header/div/div/ol/li[2] contain `, assert, '. :Assertion Passed');
}else{
console.log('Assertion Failed: Expected', assert1, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[1]/app-page-header/div/div/ol/li[2] But has`, assert , '. :Assertion Failed');
//browser.quit();
}
});
});
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[4]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert.indexOf( `Showing 1 to 10 of 2`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[4] contain Showing 1 to 10 of 2. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-cicsscreen-nat/div[5]/div[1]/div/div/div[4] But has Showing 1 to 10 of 2. :Assertion Failed`);
//browser.quit();
}
});
...
it('SankeyDiagram_testcase8' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : SankeyDiagram');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('RulesReportTotalEntriesRecord_testcase9' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RulesReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.wait(until.presenceOf(element.all(by.xpath(`//a`)).get(10)), delay, 'Element taking too long to appear in the DOM');

browser.wait(until.elementToBeClickable(element.all(by.xpath(`//a`)).get(10)), delay);
element.all(by.xpath(`//a`)).get(10).getText().then(function(text){
var description =''; 
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(`//a[10]`, text);
    }
else
    {
    Get_Text.set(`//a[10]`, text[0]);
    }  
});
element.all(by.xpath(`//a`)).get(10).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[10]`, text);
    }
else
    {
    Get_Attribute.set(`//a[10]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page62.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element.all(by.xpath(`//a`)).get(10).click();
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`))), delay);
element(by.xpath(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page65.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="pgmName"]//option[@value="AEIN1595.NAT"]`)).click();
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[2]/a`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[2]/a`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[2]/a`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[2]/a`)  }
if( typeof assert ==='object')
    {
    assert=assert[0];
    }
...
if (assert == `Showing 1 to 10 of 219 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] is equal toShowing 1 to 10 of 219 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] But has Showing 1 to 10 of 219 entries. :Assertion Failed`);
//browser.quit();
}
});

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="appln"]//option[@value="Model Management"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="appln"]//option[@value="Model Management"]`))), delay);
element(by.xpath(` //select[@id="appln"]//option[@value="Model Management"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="appln"]//option[@value="Model Management"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="appln"]//option[@value="Model Management"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="appln"]//option[@value="Model Management"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="appln"]//option[@value="Model Management"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="appln"]//option[@value="Model Management"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page67.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="appln"]//option[@value="Model Management"]`)).click();

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`))), delay);
element(by.xpath(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="pgmName"]//option[@value="VFM110.NAT"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page68.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="pgmName"]//option[@value="VFM110.NAT"]`)).click();
...
if (assert == `Showing 1 to 10 of 801 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] is equal toShowing 1 to 10 of 801 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[4] But has Showing 1 to 10 of 801 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('RulesReportParaNameDownloadButtonCheck_testcase10' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RulesReportParaNameDownloadButtonCheck');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('RulesReportShowCodeEnableCheck_testcase11' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RulesReportShowCodeEnableCheck');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[6]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
it('RulesReport_testcase12' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RulesReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div[4]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[6]/div[3]/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[7]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('RuleCategoryTotalEntriesRecord_testcase13' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RuleCategoryTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('RuleCategory_testcase14' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : RuleCategory');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[4]/div[2]/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[4]/div[3]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[4]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre3/div[4]/div[7]/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre3/div[4]/div[7]/a/img is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre3/div[4]/div[7]/a/img is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('OrphanReportTotalEntriesRecord_testcase15' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : OrphanReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/orphanApplicationNat"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/orphanApplicationNat"]`))), delay);
element(by.xpath(` //a[@href="/natural/orphanApplicationNat"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/orphanApplicationNat"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/orphanApplicationNat"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/orphanApplicationNat"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/orphanApplicationNat"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/orphanApplicationNat"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page116.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/orphanApplicationNat"]`)).click();
...
if (assert == `Showing 1 to 10 of 17 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 17 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 17 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('ProgramProcessFlow_testcase16' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ProgramProcessFlow');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[4]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[4]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[5]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[4]/div[5]/button is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[6]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('OrphanReport_testcase17' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : OrphanReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-orphanapp/div[4]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('NotPresence_testcase18' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : NotPresence');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
console.log("presence");
if (text == true){
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button is present in current page. :Assertion Failed`);
//browser.quit();
}else{
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button is not present in current page. :Assertion Passed');
}
});
...
it('NaturalPageTest_testcase19' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : NaturalPageTest');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/formsApplicationNat"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/formsApplicationNat"]`))), delay);
element(by.xpath(` //a[@href="/natural/formsApplicationNat"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/formsApplicationNat"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/formsApplicationNat"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/formsApplicationNat"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/formsApplicationNat"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/formsApplicationNat"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page158.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/formsApplicationNat"]`)).click();

browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/glossary"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/glossary"]`))), delay);
element(by.xpath(` //a[@href="/natural/glossary"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/glossary"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/glossary"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/glossary"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/glossary"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/glossary"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page159.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/glossary"]`)).click();
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/commentedlinesAppNat"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/commentedlinesAppNat"]`))), delay);
element(by.xpath(` //a[@href="/natural/commentedlinesAppNat"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/commentedlinesAppNat"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/commentedlinesAppNat"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/commentedlinesAppNat"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/commentedlinesAppNat"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/commentedlinesAppNat"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page161.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/commentedlinesAppNat"]`)).click();
...
it('MissingComponentReportTotalEntriesRecord_testcase20' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MissingComponentReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
if (assert == `Showing 1 to 10 of 51 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[4] is equal toShowing 1 to 10 of 51 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[4] But has Showing 1 to 10 of 51 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('MissingComponent_testcase21' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MissingComponent');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[2]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[2]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[2]/label/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[2]/label/input is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[2]/label/input is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-missingcompapp/div[3]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('MasterInventoryTotalEntriesRecord_testcase22' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MasterInventoryTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[2]/span`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[2]/span`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[2]/span`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[2]/span`)  }
if( typeof assert ==='object')
    {
    assert=assert[0];
    }
...
if (assert.indexOf( `Showing 1 to 10 of 49 entries`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] contain Showing 1 to 10 of 49 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 49 entries. :Assertion Failed`);
//browser.quit();
}
});
...
if (assert == `Showing 1 to 6 of 6 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 6 of 6 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has Showing 1 to 6 of 6 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('MasterInventoryTest_testcase23' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MasterInventoryTest');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[3]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('MasterInventorySearchCheck_testcase24' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MasterInventorySearchCheck');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
var assert='';
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1]/td[2]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert.indexOf( `MAP`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1]/td[2] contain MAP. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr[1]/td[2] But has MAP. :Assertion Failed`);
//browser.quit();
}
});
});
it('MasterInventoryComponentValue_testcase25' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : MasterInventoryComponentValue');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('LoginPageTest_testcase26' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : LoginPageTest');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('GlossaryTotalEntriesRecord_testcase27' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : GlossaryTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[8]/span`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[8]/span`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[8]/span`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[8]/span`)  }
if( typeof assert ==='object')
    {
    assert=assert[0];
    }
...
if (assert.indexOf( `Showing 1 to 10 of 1`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[4] contain Showing 1 to 10 of 1. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[4] But has Showing 1 to 10 of 1. :Assertion Failed`);
//browser.quit();
}
});
...
it('GlossarySpinner_testcase28' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : GlossarySpinner');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[5]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[3]/div[5] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[3]/div[5] is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[4]`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[3]/div[4] is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[3]/div[4] is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
});
it('Glossary_testcase29' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : Glossary');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[2]/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[3]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[7]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[4]/div[1]/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('ForwardCallChain_testcase30' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ForwardCallChain');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.wait(until.presenceOf(element(by.xpath(` //a[@href="/natural/callChainAppNat"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //a[@href="/natural/callChainAppNat"]`))), delay);
element(by.xpath(` //a[@href="/natural/callChainAppNat"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //a[@href="/natural/callChainAppNat"]`, text);
    }
else
    {
    Get_Text.set(` //a[@href="/natural/callChainAppNat"]`, text[0]);
    }  
});
element.all(by.xpath(` //a[@href="/natural/callChainAppNat"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//a[@href="/natural/callChainAppNat"]`, text);
    }
else
    {
    Get_Attribute.set(` //a[@href="/natural/callChainAppNat"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page233.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //a[@href="/natural/callChainAppNat"]`)).click();
...
browser.wait(until.presenceOf(element(by.xpath(` //select[@id="cmp"]//option[@value="COPYBOOK"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="cmp"]//option[@value="COPYBOOK"]`))), delay);
element(by.xpath(` //select[@id="cmp"]//option[@value="COPYBOOK"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="cmp"]//option[@value="COPYBOOK"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="cmp"]//option[@value="COPYBOOK"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="cmp"]//option[@value="COPYBOOK"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="cmp"]//option[@value="COPYBOOK"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="cmp"]//option[@value="COPYBOOK"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page235.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="cmp"]//option[@value="COPYBOOK"]`)).click();

browser.wait(until.presenceOf(element(by.xpath(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`))), delay, 'Element taking too long to appear in the DOM');
browser.wait(until.elementToBeClickable(element(by.xpath(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`))), delay);
element(by.xpath(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`)).getText().then(function(text){  
var description ='';  
    if( typeof text ==='object')
    { description=text[0];}
    else{ description=text;} 
...
if( typeof text ==='object')
    {
    Get_Text.set(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`, text);
    }
else
    {
    Get_Text.set(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`, text[0]);
    }  
});
element.all(by.xpath(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`)).getAttribute('value').then(function (text) {
if( typeof text ==='object')
    {
    Get_Attribute.set(`//select[@id="cmpName"]//option[@value="CCBEGIN"]`, text);
    }
else
    {
    Get_Attribute.set(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`, text[0]);
    }  
});
browser.takeScreenshot().then(function (png) {var dir="natural";
var fname="page236.png"; var stream1 = fs.createWriteStream(path.join(dir, fname));
                        stream1.write(new Buffer(png, 'base64'));
                        stream1.end();});
element(by.xpath(` //select[@id="cmpName"]//option[@value="CCBEGIN"]`)).click();
...
it('ExcelDownload_testcase31' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ExcelDownload');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('EmptyTable_testcase32' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : EmptyTable');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[3]/div[2]/table/tbody/tr/td contain No data available in table. :Assertion Passed` );
}else{
...
it('DynamicProcessFlow_testcase33' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DynamicProcessFlow');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[1]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[1]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[1]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[3]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[3]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-programprocessflowext/div[5]/div[1]/div[2]/div[3]/button is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('DropImpactReportTotalEntriesRecord_testcase34' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DropImpactReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
if (assert == `Showing 1 to 10 of 76 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 76 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 76 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('DropImpactReport_testcase35' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DropImpactReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[2]/label/input`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[2]/label/input is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-dropimpactapp/div[4]/div/div/div/div[2]/label/input is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('DetailedReportTotalEntriesRecord_testcase36' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DetailedReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[1]/a/span`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[1]/a/span`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[1]/a/span`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/div[2]/li/ul/li[1]/a/span`)  }
if( typeof assert ==='object')
    {
    assert=assert[0];
    }
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert.indexOf( `Showing 1 to 10 of 1`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] contain Showing 1 to 10 of 1. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] But has Showing 1 to 10 of 1. :Assertion Failed`);
//browser.quit();
}
});
...
if (assert == `Showing 1 to 10 of 624 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] is equal toShowing 1 to 10 of 624 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[4] But has Showing 1 to 10 of 624 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('DetailedReport_testcase37' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DetailedReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[3]/div[2]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[3]/div[2]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[3]/div[4]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[3]/div[4]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[3]/div[5]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[3]/div[5]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[3]/div[5]/button is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[1]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[1]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[2]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[2]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[4]/div[3]/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[4]/div[3]/a/img is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[4]/div[3]/a/img is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-bre/div[5]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('DeadReportTotalEntriesRecord_testcase38' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DeadReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
var assert='';
element(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 4 of 4 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] But has Showing 1 to 4 of 4 entries. :Assertion Failed`);
//browser.quit();
}
});
...
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 2 of 2 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[4] But has Showing 1 to 2 of 2 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('DeadParaReport_testcase39' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DeadParaReport');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[3]/select is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[3]/select is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[4]/button is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[3]/div[4]/button is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[1]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[1]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[2]/label is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[2]/label is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/a/img is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/a/img is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
console.log('Assertion Passed: Expected element xpath /html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[3]/div[1]/div/table is present in current page. :Assertion Passed');
}else{
console.log(`Assertion Failed: Expected element xpath/html/body/app-root/app-layout/section/app-deadparaapp/div[4]/div/div/div/div[3]/div[1]/div/table is not present in current page. :Assertion Failed`);
//browser.quit();
}
});
...
it('DashboardPageTest_testcase40' , function() {browser.ignoreSynchronization =true;
...
it('DashboardComponentValueCheck_testcase41' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DashboardComponentValueCheck');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
var assert='';
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4]`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert.indexOf( `xpath=(//h2)[2]`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] contain xpath=(//h2)[2]. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has xpath=(//h2)[2]. :Assertion Failed`);
//browser.quit();
}
});
...
it('DashboardComponentValue_testcase42' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : DashboardComponentValue');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
if (assert.indexOf( `49`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dashboard/div[1]/div[2]/div[1]/a/app-stat/div/div/div/div[2]/div[1]/h2 contain 49. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-dashboard/div[1]/div[2]/div[1]/a/app-stat/div/div/div/div[2]/div[1]/h2 But has 49. :Assertion Failed`);
//browser.quit();
}
...
if (assert.indexOf( `49`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] contain 49. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-masterinvapp/div[4]/div/div/div/div[4] But has 49. :Assertion Failed`);
//browser.quit();
}
});
...
it('CRUDTotalEntriesRecord_testcase43' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CRUDTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
if (assert.indexOf( `CRUD`)!== -1){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[1]/app-page-header/div/div/ol/li[2] contain CRUD. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[1]/app-page-header/div/div/ol/li[2] But has CRUD. :Assertion Failed`);
//browser.quit();
}
});
...
if (assert == `Showing 1 to 10 of 88 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 88 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 88 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('CRUD_testcase44' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CRUD');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-formapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
it('ControlFlow_testcase45' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ControlFlow');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-controlflowapp/div[2]/div/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-controlflowapp/div[2]/div/div[4]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-controlflowapp/div[3]/div/div[2]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-controlflowapp/div[3]/div/div[3]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
it('CommentedLinesReportTotalEntriesRecord_testcase46' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CommentedLinesReportTotalEntriesRecord');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(5000);element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[10]/span`)).isPresent().then(function (text) {
console.log("presence");
var assert='';
if (text == true){
console.log('xpath in same page');
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[10]/span`)).getText().then(function (text){
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if(`getText()`=="getText()"){
assert=Get_Text.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[10]/span`)  }
if(`getText()`=="getAttribute('value')"){
assert=Get_Attribute.get(`/html/body/app-root/app-layout/app-sidebar/nav/div[1]/a[10]/span`)  }
if( typeof assert ==='object')
    {
    assert=assert[0];
    }
...
if (assert == `Showing 1 to 10 of 17 entries`){
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] is equal toShowing 1 to 10 of 17 entries. :Assertion Passed` );
}else{
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[4] But has Showing 1 to 10 of 17 entries. :Assertion Failed`);
//browser.quit();
}
});
...
it('CommentedLines_testcase47' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CommentedLines');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[3]/div[3]/select`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[3]/div[4]/button`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[1]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[2]/label`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/a/img`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
element.all(by.xpath(`/html/body/app-root/app-layout/section/app-commentedlinesapp/div[4]/div/div/div/div[3]/div[1]/div/table`)).isPresent().then(function (text) {
console.log("presence");
if (text == true){
...
it('ColorCheck_testcase48' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : ColorCheck');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
it('CollapseTest_testcase49' , function() {browser.ignoreSynchronization =true;
						console.log('Application_name : Natural, Scenario_name : CollapseTest');
                        browser.driver.manage().window().maximize();
                        browser.get("https://lcaas.techmahindra.com/natural/");
                        browser.waitForAngularEnabled(false);
                        browser.sleep(10);
...
browser.sleep(1000);var assert='';
element(by.xpath(`/html/body/app-root/app-layout/app-sidebar/nav/div[2]/span`)).getText().then(function (text) {
if( typeof text ==='object')
    {
    assert=text[0];
    }
...
if (assert == `Collapse Sidebar`){
console.log('Assertion Failed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/span and has same value Collapse Sidebar. :Assertion Failed`);
//browser.quit();
}else{
console.log('Assertion Passed: Expected', assert, `for the Xpath/html/body/app-root/app-layout/app-sidebar/nav/div[2]/span contain Collapse Sidebar. :Assertion Passed` );
}
});
